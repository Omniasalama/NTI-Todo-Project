...
export default function Footer() {
  return (
    <footer className="bg-[#F2E8E0]">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link to="" className="flex items-center">
              <span className="self-center text-xl font-bold whitespace-nowrap text-[#1A1612]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-body font-medium">
                <li className="mb-4">
                  <Link className="hover:underline hover:text-[#C8571A]">
                    ToDo{" "}
                    <span className="text-[#C8571A] hover:text-body">App</span>
                  </Link>
                </li>
                <li>
                  <Link
                    href="https://tailwindcss.com/"
                    className="hover:underline hover:text-[#C8571A]"
                  >
                    Tailwind CSS
                  </Link>
                </li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <Link href="#" className="text-body hover:text-[#C8571A] ms-5">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
